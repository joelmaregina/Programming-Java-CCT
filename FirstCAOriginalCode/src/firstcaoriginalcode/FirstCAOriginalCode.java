 ...
 */
package firstcaoriginalcode;

/**
 *
 * @author joelm
 */
public class FirstCAOriginalCode {
 ...
 /* YOU HAVE TO 
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("Output message 1: " + movieName.length());
        
        if (!movieName.contains("Star")){
            
            System.out.println("Output message 2");
            
        }
        else
        {
            System.out.println("Output message 3");
        }
